...
latex_documents = [
    (master_doc, 'test-project.tex', 'test-project Documentation',
     'author', 'manual'),
]
...
man_pages = [
    (master_doc, 'test-project', 'test-project Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'test-project', 'test-project Documentation',
     author, 'test-project', 'One line description of project.',
     'Miscellaneous'),
]
