...
If :code:`test-project` is available in your opam repository, you can just call::

  opam install test-project

Build and install with :code:`dune`
-----------------------------------

Checkout the sources of :code:`test-project` in a directory.
